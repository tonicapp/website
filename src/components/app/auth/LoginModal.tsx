import { Box, Progress, PasswordInput, Group, Text, Center, Modal, TextInput, Tabs, Button } from '@mantine/core';
...
export default function LoginModal(props: {opened: boolean, close: () => void}) {
  ...
  return(
    <Modal opened={props.opened} onClose={props.close} radius="xl" withCloseButton={false}>
